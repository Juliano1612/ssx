...
import { Web3Auth } from './modules/Auth/Web3Auth';
...
export class SSX {
  ...
  //   }
  // ): Promise<SSXEnsData> {
  //   return this.auth.resolveEns(address, resolveEnsOpts);
  // }
  ...
  //   return this.auth.resolveLens(address, pageCursor);
  // }
  ...
  //   return this.auth.provider.getSigner();
  // }
}
